(function() {
    tinymce.create('tinymce.plugins.ColegaShortcodes', {
        init : function(ed, url) {
            ed.addButton('colega_shortcode_button', {
				type: 'menubutton',
				text: 'B',
				title: 'Insert Colega Shortcode',
                icon: false,
					...
					// Elements
					{
                        ...
                        menu: [
							...
							
							{
								text: 'Video Hosted',
								onclick: function () {
									tb_show("Add hosted video", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup.php?&sc=colega_video&width=400&height=500');
								}
							},
		...
		getInfo: function () {
            return {
				...
				longname: 'Colega Shortcodes',
                author: 'Clapat Studio',
                authorurl: 'http://themeforest.net/user/clapat/',
                infourl: 'http://clapat.ro/themes/colega-wordpress/',
                version: "1.0"
            }
        }
    });
    // Register plugin
    tinymce.PluginManager.add( 'ColegaShortcodes', tinymce.plugins.ColegaShortcodes );
})();