...
namespace Clapat\Colega\Metaboxes;

/**
 * Class for creating custom meta boxes in WordPress. 
 * 
 */
	if( !class_exists( "Clapat\Colega\Metaboxes\Meta_Boxes" ) ){
		...
		class Meta_Boxes {
			...
			public static function build_metabox( $post, $args ) {
				...
				$admin_notices .= '<div class="clapat-metabox-notice-save" style="display:none;">' . __('Settings have changed, you should save them!', 'clapat_colega_plugin_text_domain') . '</div>';
				$admin_notices .= '</div>';
			...
			public static function init() {
				...
				add_action( 'clapat/colega/add_metaboxes', array( __CLASS__, 'register_metabox_definitions' ) );
