...
class WP_Mapbox_GL_JS_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style('mapbox_gl_js_css', 'https://api.tiles.mapbox.com/mapbox-gl-js/v0.43.0/mapbox-gl.css');
	...
	public function enqueue_scripts() {
			...
			wp_enqueue_script('mapbox_gl_js', 'https://api.tiles.mapbox.com/mapbox-gl-js/v0.43.0/mapbox-gl.js', array('jquery'), '', false);
		...
		if($atts['map_id']!=='') {
			...
			?>
				...
				<div
					...
					data-mapdata='<?php echo json_encode($map_object->mapData); ?>'
