...
function lebotheme_get_image_metadata( $image_id ){

    $image_metadata     = array();
    $image_title        = esc_html__("Image Title", 'lebotheme');
    $image_caption      = "";
    $image_desc         = esc_html__("Image Description", 'lebotheme');
...
function lebotheme_hex2rgb($hex) {
...
function lebotheme_hex2rgba($hex, $opacity = '0') {

    $rgbval = lebotheme_hex2rgb( $hex );
