...
$lebotheme_max_items		= lebotheme_get_post_meta( lebotheme_THEME_OPTIONS, get_the_ID(), 'lebotheme-opt-page-portfolio-mixed-items' );
if( empty($lebotheme_max_items) ){
	$lebotheme_max_items = 1000;
}
		...
		<div id="main">
			...
			<div id="main-content">
				<div id="main-page-content">
					...
					<?php 
						if( $lebotheme_content_after == "before" ){
							the_content();
						} 
					?>
					...
					<?php 
						if( $lebotheme_content_after == "after" ){
							the_content();
						} 
					?>
