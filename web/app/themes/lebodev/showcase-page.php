...
?>
		...
		<div id="main">
			...
			<div id="main-content">
				...
				<div id="showcase-slider-holder" class="disable-drag <?php if( !lebotheme_get_theme_options('clapat_lebotheme_enable_ajax') ) { echo 'thumb-no-ajax'; } ?>"> 
										...
										while( $lebotheme_portfolio->have_posts() ){
											...
											if( $lebotheme_showcase_include == "yes" ){
												...
												<div class="swiper-slide" data-slide="<?php echo esc_attr( sprintf( "%2d", $lebotheme_slides_count ) ); ?>">                                    
													<div class="img-mask">
														<div class="section-image" data-swiper-parallax="0" data-swiper-parallax-scale="1.15">
